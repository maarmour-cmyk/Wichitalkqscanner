#!/usr/bin/env python3
"""Wichita LKQ V10.5 cloud market + VIN-fitment scanner.
...
def fetch_inventory(max_pages=75):
    s=requests.Session(); s.headers["User-Agent"]="Mozilla/5.0 WichitaPartsScanner/10.5"
...
def main():
    ...
    try:
        ...
        if learning_rows: supa_upsert_many("scanner_sales_learning",learning_rows,"part_key",batch_size=250)
