...
st.set_page_config(
    page_title="Wichita Parts Profit Scanner V7",
    page_icon="🔧",
    layout="wide",
...
def price_candidates(cands,max_queries,progress=None):
    ...
    for _,r in subset.iterrows():
        ...
        entry=st.session_state.market_cache.get(key,{"query":q})
        entry["query"]=q
...
# ---------------- UI ----------------
st.title("🔧 Wichita Parts Profit Scanner V7")
...
with tabs[7]:
    ...
    setup_tabs=st.tabs(["Market APIs","LKQ prices","Impact","Shipping","Watchlist","Backup"])
